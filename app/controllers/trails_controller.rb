class TrailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trail.save
        format.html { redirect_to trail_url(@trail), notice: "Trail was successfully created." }
  ...
  def update
    respond_to do |format|
      if @trail.update(trail_params)
        format.html { redirect_to trail_url(@trail), notice: "Trail was successfully updated." }
